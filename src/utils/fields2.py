...
fiscal_year_attributes = ["performance_highlights"]
...
strat_outlook_attributes = ["strategic_initiatives"]
...
risk_management_attributes = ["risk_factors"]
...
innovation_attributes = ["r_and_d_activities"]